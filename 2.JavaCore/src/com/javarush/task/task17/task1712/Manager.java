...
public class Manager {      //singleton
    private static Manager ourInstance = new Manager(); //создание менеджера3 конец, создали

    private final List<Table> restaurantTables = new ArrayList<Table>(10); //список столов в ресторане
    ...
    public Queue<Order> getOrderQueue() {
        return orderQueue;
    } //от цикла вайл повара

    public Queue<Dishes> getDishesQueue() {
        return dishesQueue;
    } //от цикла вайл официанта
}
